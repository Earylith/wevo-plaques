  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Équipements & services, avec leurs notices",
        "Bonnes adresses autour du logement",
        "Transports et lignes à proximité",
        "Questions fréquentes",
        "Livre d'or",
        "Météo, carte et heure locale",
